# SMS Bridge Technical Snippets v2.4
...
> For simple explanations of WHAT and WHY, see [SMS_Bridge_tech_spec_v2.4.md](SMS_Bridge_tech_spec_v2.4.md)
...
### sms_settings.json (Settings Template v2.4)

**Complete settings structure matching SettingsPayload schema:**
